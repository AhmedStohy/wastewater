...
def getData(city, year, month_from, month_to, fileName):
    ...
    prefix = "https://m.tianqi.com/lishi/" + city + "/" + str(
        year)  # 格式为https://m.tianqi.com/lishi/chongqing/201907.html
    suffix = ".html"
    # 遍历月份
    for i in range(month_from, month_to + 1):
        ...
        for i in range(1, days + 1):
            ...
            if the_day:  # 有的数据丢失导致None对象
                ...
                file.write(url[-11:-5] + day + "," + str(temperature).replace('~', ',') + "\n")
    file.close()
